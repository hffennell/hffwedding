...
import HeroImage from 'public/images/ag-film-hero.jpg';
				...
				<div className="section absolute top-0 w-full h-full flex flex-col">
					<div className="section w-full h-screen flex-shrink-0 flex flex-col items-center mb-1">
						<div className="text-center my-auto">
							<h1 className="text-4xl sm:text-5xl lg:text-6xl text-white tracking-wide font-script py-10 px-8">Alexa & Grayson</h1>
						</div>
					</div>
        </div>
      </section>
